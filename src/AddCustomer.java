...
public class AddCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "Add Customer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 20), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gendral", "Paid" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Genuine Engine Oil 4T plus", "Nil", " " }));
        ...
        setSize(new java.awt.Dimension(882, 733));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try{
            ...
            String date=date_f.format(jDateChooser1.getDate()); 
            ...
            String servicetype=(String)jComboBox2.getSelectedItem();
            String oilchange=(String)jComboBox3.getSelectedItem();
            String oiltype=(String)jComboBox4.getSelectedItem();
            
            String sql="insert into GendralDetails(name,address,phonenumber,date,gender,motorcycledetails,"
                    + "model,rengNo,Km,colour,servicetype,Oilchange,Typeofoil) values('"+customername+"','"+address+"',"
                    + "'"+phoneno+"','"+date+"','"+gender+"','"+motordetails+"','"+model+"','"+regnno+"',"
                    + "'"+km+"','"+colour+"','"+servicetype+"','"+oilchange+"','"+oiltype+"')";
